...
//        nodeUtil._logN.call(this, "moveTo");
...
//        nodeUtil._logN.call(this, "lineTo");
...
//        nodeUtil._logN.call(this, "bezierCurveTo");
        var p = this.getCoords_(aX, aY);
    ...
    contextPrototype.quadraticCurveTo = function (aCPx, aCPy, aX, aY) {
        nodeUtil._logN.call(this, "quadraticCurveTo");
        ...
        for (var i = 0; i < this.currentPath_.length; i++) {
            ...
            switch (p.type) {
                ...
                case 'lineTo':
                    if (!aFill) { //lines
                        if (i > 0) {
                            _drawPDFLine.call(this, this.currentPath_[i-1], p, lineWidth);
                        }
                    }
                    break;
                case 'close':
